...
if __name__ == '__main__':
    ...
    dataset_test = NYU_Dataset('D:/data/NYU/val',[net_w,net_h],printName=True,returnName=True)
    ...
    test_stop_when_threshold(model,loader_test,device,show=False,write_csv=False)