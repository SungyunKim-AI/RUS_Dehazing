...
if __name__=='__main__':
    ...
    for data in tqdm(dataloader):
        ...
        # print(ato)
        vutils.save_image(input, f'airlight_validate/hazy/{imgname[0]}.png', normalize=False, scale_each=False)
        vutils.save_image(ato, f'airlight_validate/airlight/{imgname[0]}.png', normalize=False, scale_each=False)
