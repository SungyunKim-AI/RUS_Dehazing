...
if __name__ == '__main__':
    ...
    now = datetime.now()
    writer = SummaryWriter(f'[valid]runs-{now.day}_{now.hour}_{now.minute}_{now.second}')
    print(f'[valid]runs-{now.day}_{now.hour}_{now.minute}_{now.second}')
