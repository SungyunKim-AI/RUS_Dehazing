...
def run(opt, encoder, decoder, loader, airlight_module, entropy_module, improve_best_list=None):
    
    output_folder = 'D:/data/output_depth/Monodepth_' + opt.dataset
    ...
    for batch in tqdm(loader):
        ...
        with torch.no_grad():
            ...
            _, depth_images = disp_to_depth(decoder(encoder(clear_images))[("disp", 0)], 1, 100)
            ...
            _, init_depth = disp_to_depth(decoder(encoder(cur_hazy))[("disp", 0)], 1, 100)
        ...
        for step in range(0,steps):
            with torch.no_grad():
                ...
                _, cur_depth = disp_to_depth(cur_depth, 1, 100)
...
if __name__ == '__main__':
    ...
    loader_args = dict(batch_size=1, num_workers=3, drop_last=False, shuffle=True)
    ...
    # Improve best
    # df1 = pd.read_csv('D:/data/output_depth/Monodepth_depth_KITTI/_statistics/_0.02_a1_improve.csv')
    # df2 = pd.read_csv('D:/data/output_depth/Monodepth_depth_KITTI/_statistics/_0.04_a1_improve.csv')
    # df3 = pd.read_csv('D:/data/output_depth/Monodepth_depth_KITTI/_statistics/_0.06_a1_improve.csv')
    ...
    run(opt, encoder, depth_decoder, val_loader, airlight_module, entropy_module, improve_best_list=None)
